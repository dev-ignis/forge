...
describe('ForgeToast', () => {
  ...
  describe('User Interactions', () => {
    it('should have dismiss button when dismissible', async () => {
      ...
      const dismissButton = element.shadowRoot?.querySelector('[part="dismiss"]') as HTMLButtonElement;
      expect(dismissButton).to.exist;
  ...
  describe('Methods', () => {
    it('should dismiss with custom event', () => {
      element.toastId = 'test-toast';
      
      let eventFired = false;
      let eventDetail: any = null;
      
      element.addEventListener('toast-dismissed', (event: Event) => {
      ...
      // Mock the animation end event to trigger the toast-dismissed event
