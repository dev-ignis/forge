...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A versatile avatar component for displaying user identity with image support, fallback text/initials, and status indicators.',
      },
    },
  },
  argTypes: {
...
const Template = (args: any) => html`
  <forge-avatar
    ...
    @click=${(e: Event) => console.log('Avatar clicked:', e)}
  ></forge-avatar>
`;
    ...
    <div style="max-width: 300px; border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden;">
      ${[
        ...
        },
        {
          ...
          initials: 'JS',
          avatar:
            'https://images.unsplash.com/photo-1494790108755-2616b612b1eb?w=150&h=150&fit=crop&crop=face',
        },
        ...
        "
          >
            ...
            ></forge-avatar>
            <div style="flex: 1;">
              <h4 style="margin: 0 0 0.25rem 0; color: #111827; font-size: 0.875rem;">
                ${user.name}
              </h4>
...
export const CommentThread: Story = {
  render: () => html`
    <div style="max-width: 500px; font-family: system-ui;">
      ${[
        {
          name: 'Sarah Connor',
          comment: 'This looks great! The new design is much more intuitive.',
          time: '2 hours ago',
          initials: 'SC',
          avatar:
            'https://images.unsplash.com/photo-1494790108755-2616b612b1eb?w=150&h=150&fit=crop&crop=face',
        ...
        {
          name: 'John Doe',
          comment: 'I agree, but I think we should adjust the spacing on mobile devices.',
          time: '1 hour ago',
          initials: 'JD',
          avatar: '',
        },
        {
          name: 'Mike Wilson',
          comment: "Good point! I'll make those adjustments in the next iteration.",
          time: '30 minutes ago',
          initials: 'MW',
          avatar:
            'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face',
        ...
        "
          >
            ...
            <div style="flex: 1;">
              ...
              <p style="margin: 0; color: #374151; font-size: 0.875rem; line-height: 1.4;">
                ${comment.comment}
              </p>
            </div>
          </div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Avatars used in a comment thread showing user interactions with rounded shape variant.',
      },
    },
  },
};
...
export const AccessibilityDemo: Story = {
  render: () => html`
    <div style="display: flex; flex-direction: column; gap: 1rem; max-width: 400px;">
      ...
      <ul
        style="font-family: system-ui; color: #6b7280; font-size: 0.875rem; margin: 0; padding-left: 1rem;"
      >
      ...
      <div style="display: flex; gap: 1rem; align-items: center;">
        <forge-avatar
          ...
          size="lg"
          @click=${() =>
            console.log('Focus on keyboard navigation with Tab, activate with Enter/Space')}
        ></forge-avatar>
