...
## v0.5.2-beta.24 - 2025-09-15 (Beta Release)

### 🧪 Beta Changes
- feat: - husky;
- feat: split RHF adapters into separate @nexcraft/forge-rhf package
- docs: - phase 14;
- docs: - plans for monorepo and release;
- Merge branch 'develop' of https://github.com/dev-ignis/forge into develop
- fix: - date picker test;
- feat: comprehensive AI discoverability and documentation                                                                                                                                                                                                  │ │                                                                                                                                                                                                                                                                            │ │   Adds complete AI-native development support for tools like Cursor, GitHub Copilot, and Claude Code.                                                                                                                                                                      │ │                                                                                                                                                                                                                                                                            │ │   ## AI Discoverability                                                                                                                                                                                                                                                    │ │   - Enhanced package.json with AI-focused keywords and metadata                                                                                                                                                                                                            │ │   - Added prominent AI discovery section to README                                                                                                                                                                                                                         │ │   - Created structured ai-manifest.json with component metadata                                                                                                                                                                                                            │ │   - Added .cursorrules for Cursor IDE integration                                                                                                                                                                                                                          │ │                                                                                                                                                                                                                                                                            │ │   ## Documentation                                                                                                                                                                                                                                                         │ │   - docs/AI_COMPONENT_CATALOG.md: Copy-paste component examples                                                                                                                                                                                                            │ │   - docs/patterns/AI_COMMON_PATTERNS.md: Complete UI patterns (login, dashboard, forms)                                                                                                                                                                                    │ │   - docs/guides/AI_IMPORT_GUIDE.md: Framework-specific import guides                                                                                                                                                                                                       │ │                                                                                                                                                                                                                                                                            │ │   ## Build Process                                                                                                                                                                                                                                                         │ │   - Fixed ES module generation in scripts/build-exports.cjs                                                                                                                                                                                                                │ │   - Resolves selective imports and Tailwind plugin compatibility                                                                                                                                                                                                           │ │                                                                                                                                                                                                                                                                            │ │   Now AI tools can generate perfect Forge code for common prompts like:                                                                                                                                                                                                    │ │   - "Create a login form" → Gets complete React Hook Form example                                                                                                                                                                                                          │ │   - "Build a dashboard" → Gets metrics cards + data table pattern                                                                                                                                                                                                          │ │   - "Import components" → Gets correct import path for any framework
> ⚠️ **This is a beta release** - use with caution in production environments

## v0.5.2-beta.23 - 2025-09-14 (Beta Release)

### 🧪 Beta Changes
- Merge branch 'develop' of https://github.com/dev-ignis/forge into develop
- fix: - integrate plugin and exports generation into build process;
> ⚠️ **This is a beta release** - use with caution in production environments
...
## v0.5.2-beta.20 - 2025-09-12 (Beta Release)

### 🧪 Beta Changes
- Merge branch 'develop' of https://github.com/dev-ignis/forge into develop
- fix: - ReactHookFormAdapters;
> ⚠️ **This is a beta release** - use with caution in production environments
