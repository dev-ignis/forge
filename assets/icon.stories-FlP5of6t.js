import{f as fe,u as ue,i as he,a as me,E as k,T as xe,x as l}from"./iframe-DCJe_mAx.js";import"./preload-helper-C1FmrZbK.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ve={attribute:!0,type:String,converter:ue,reflect:!1,hasChanged:fe},be=(t=ve,e,n)=>{const{kind:i,metadata:r}=n;let s=globalThis.litPropertyMetadata.get(r);if(s===void 0&&globalThis.litPropertyMetadata.set(r,s=new Map),i==="setter"&&((t=Object.create(t)).wrapped=!0),s.set(n.name,t),i==="accessor"){const{name:d}=n;return{set(g){const S=e.get.call(this);e.set.call(this,g),this.requestUpdate(d,S,t)},init(g){return g!==void 0&&this.C(d,void 0,t,g),g}}}if(i==="setter"){const{name:d}=n;return function(g){const S=this[d];e.call(this,g),this.requestUpdate(d,S,t)}}throw Error("Unsupported decorator location: "+i)};function a(t){return(e,n)=>typeof n=="object"?be(t,e,n):((i,r,s)=>{const d=r.hasOwnProperty(s);return r.constructor.createProperty(s,i),d?Object.getOwnPropertyDescriptor(r,s):void 0})(t,e,n)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function f(t){return a({...t,state:!0,attribute:!1})}var we=Object.defineProperty,m=(t,e,n,i)=>{for(var r=void 0,s=t.length-1,d;s>=0;s--)(d=t[s])&&(r=d(e,n,r)||r);return r&&we(e,n,r),r};const A=class A extends he{constructor(){super(),this.ariaDescription=null,this.maxRenderMs=16,this.warnOnViolation=!1,this.performanceMode="auto",this.devMode=!1,this.showMetrics=!1,this.renderTime=0,this.renderCount=0,this.performanceStartTime=0,this.aiMetadata={purpose:"UI Component",criticality:"low"},this.performanceStartTime=globalThis.performance.now()}checkPerformance(e){const n=globalThis.performance.now();if(this.renderTime=n-e,this.renderCount++,this.renderTime>this.maxRenderMs){const i=`${this.tagName} render exceeded budget: ${this.renderTime.toFixed(2)}ms > ${this.maxRenderMs}ms`;this.warnOnViolation&&console.warn(i,{component:this.tagName.toLowerCase(),renderTime:this.renderTime,maxRenderMs:this.maxRenderMs,renderCount:this.renderCount,performanceMode:this.performanceMode}),this.performanceMode==="auto"&&this.applyPerformanceDegradation()}this.devMode&&console.log(`${this.tagName} render metrics:`,{component:this.tagName.toLowerCase(),renderTime:this.renderTime,renderCount:this.renderCount,totalTime:n-this.performanceStartTime})}applyPerformanceDegradation(){}get aiState(){return{component:this.tagName.toLowerCase(),semanticRole:this.semanticRole,context:this.aiContext,description:this.ariaDescription,metadata:this.aiMetadata,attributes:this.getAttributeNames().reduce((e,n)=>(e[n]=this.getAttribute(n),e),{})}}getAIDescription(){const e=`${this.tagName.toLowerCase()} component`,n=this.aiMetadata.purpose||"UI interaction",i=this.semanticRole?` with role ${this.semanticRole}`:"",r=this.aiContext?` in ${this.aiContext} context`:"";return`${e} for ${n}${i}${r}`}getPossibleActions(){return[]}explainState(){return{currentState:"default",possibleStates:["default"],stateDescription:"Component in default state"}}emit(e,n,i){const r=new CustomEvent(e,{detail:n,bubbles:!0,composed:!0,cancelable:!0,...i});return this.dispatchEvent(r)}announceToScreenReader(e){const n=document.createElement("div");n.setAttribute("aria-live","polite"),n.setAttribute("aria-atomic","true"),n.style.position="absolute",n.style.left="-10000px",n.style.width="1px",n.style.height="1px",n.style.overflow="hidden",n.textContent=e,document.body.appendChild(n),setTimeout(()=>document.body.removeChild(n),1e3)}firstUpdated(e){super.firstUpdated(e),this.setAttribute("data-ready","true")}trapFocus(e=this){const n=e.querySelectorAll('a[href], button, textarea, input, select, [tabindex]:not([tabindex="-1"])'),i=n[0],r=n[n.length-1];e.addEventListener("keydown",s=>{s.key==="Tab"&&(s.shiftKey&&document.activeElement===i?(s.preventDefault(),r==null||r.focus()):!s.shiftKey&&document.activeElement===r&&(s.preventDefault(),i==null||i.focus()))})}};A.styles=me`
    :host {
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class $ extends Ie{constructor(e){if(super(e),this.it=k,e.type!==ze.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===k||e==null)return this._t=void 0,this.it=e;if(e===xe)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const n=[e];return n.raw=n,this._t={_$litType$:this.constructor.resultType,strings:n,values:[]}}}$.directiveName="unsafeHTML",$.resultType=1;const Ce=Me($);var Re=Object.defineProperty,Se=Object.getOwnPropertyDescriptor,c=(t,e,n,i)=>{for(var r=i>1?void 0:i?Se(e,n):e,s=t.length-1,d;s>=0;s--)(d=t[s])&&(r=(i?d(e,n,r):d(r))||r);return i&&r&&Re(e,n,r),r};let o=class extends p{constructor(){super(...arguments),this.size="md",this.spin=!1,this.pulse=!1,this.ariaDescription=null,this.maxRenderMs=16,this.warnOnViolation=!1,this.performanceMode="auto",this.devMode=!1,this.showMetrics=!1,this.loading=!1,this.error=!1,this.renderTime=0,this.renderCount=0}static registerIcon(t,e,n){this.iconRegistry.set(t,{svg:e,viewBox:n})}static registerIcons(t){Object.entries(t).forEach(([e,n])=>{typeof n=="string"?this.registerIcon(e,n):this.registerIcon(e,n.svg,n.viewBox)})}static async loadIconSet(t){try{const n=await(await fetch(t)).json();this.registerIcons(n)}catch(e){throw console.error("Failed to load icon set:",e),e}}connectedCallback(){super.connectedCallback(),this.updateAria()}firstUpdated(){const t=performance.now();if(this.name&&o.iconRegistry.has(this.name)){this.iconData=o.iconRegistry.get(this.name),this.error=!1,this.trackRenderPerformance(t);return}this.name||this.src?this.loadIcon():this.trackRenderPerformance(t)}updated(t){super.updated(t);const e=t.has("name"),n=t.has("src");if(!(t.has("name")&&t.get("name")===void 0||t.has("src")&&t.get("src")===void 0)&&(e||n))if(this.name&&o.iconRegistry.has(this.name)){const r=performance.now();this.iconData=o.iconRegistry.get(this.name),this.error=!1,this.trackRenderPerformance(r)}else(this.name||this.src)&&this.loadIcon();(t.has("label")||t.has("semanticRole")||t.has("aiContext"))&&this.updateAria()}async loadIcon(){const t=performance.now();if(this.name){const e=o.iconRegistry.get(this.name);if(e){this.iconData=e,this.error=!1,this.trackRenderPerformance(t);return}this.src?await this.loadFromUrl(this.src):(this.error=!0,console.warn(`Icon "${this.name}" not found in registry`))}else this.src&&await this.loadFromUrl(this.src);this.trackRenderPerformance(t)}async loadFromUrl(t){const e=o.loadingIcons.get(t);if(e)try{this.iconData=await e,this.error=!1;return}catch{this.error=!0;return}const n=this.fetchIcon(t);o.loadingIcons.set(t,n);try{this.loading=!0,this.iconData=await n,this.error=!1,this.name&&o.iconRegistry.set(this.name,this.iconData)}catch(i){this.error=!0,console.error("Failed to load icon:",i)}finally{this.loading=!1,o.loadingIcons.delete(t)}}async fetchIcon(t){const e=await fetch(t);if(!e.ok)throw new Error(`Failed to fetch icon: ${e.statusText}`);const n=await e.text(),s=new DOMParser().parseFromString(n,"image/svg+xml").querySelector("svg");if(!s)throw new Error("Invalid SVG file");const d=s.getAttribute("viewBox")||void 0;return{svg:s.innerHTML,viewBox:d}}updateAria(){const t=this.label?"img":"presentation";this.setAttribute("role",t),this.label?this.setAttribute("aria-label",this.label):this.removeAttribute("aria-label"),this.ariaDescription&&this.setAttribute("aria-description",this.ariaDescription),this.semanticRole&&this.setAttribute("data-semantic-role",this.semanticRole),this.aiContext&&this.setAttribute("data-ai-context",this.aiContext)}trackRenderPerformance(t){const e=performance.now();if(this.renderTime=e-t,this.renderCount++,this.renderTime>this.maxRenderMs){const n=`Icon render exceeded budget: ${this.renderTime.toFixed(2)}ms > ${this.maxRenderMs}ms`;this.warnOnViolation&&console.warn(n,{component:"forge-icon",name:this.name,renderTime:this.renderTime,maxRenderMs:this.maxRenderMs,renderCount:this.renderCount}),this.performanceMode==="auto"&&this.applyPerformanceDegradation()}this.devMode&&console.log("Icon render metrics:",{component:"forge-icon",name:this.name,renderTime:this.renderTime,renderCount:this.renderCount,cacheHit:!!o.iconRegistry.get(this.name||"")})}applyPerformanceDegradation(){this.spin=!1,this.pulse=!1}render(){const t=this.renderIcon(),e=this.showMetrics?this.renderMetrics():null;return l`
      ${e}
      ${t}
...
\`\`\`
  ...
  `},R={name:"Custom Icon Registration",render:()=>(o.registerIcon("custom-logo",`
      <g>
    ...
    `)};var T,D,L;u.parameters={...u.parameters,docs:{...(T=u.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: args => html\`
    <forge-icon
      name="\${args.name || 'home'}"
      size="\${args.size}"
    ...
    ></forge-icon>
  \`
}`,...(L=(D=u.parameters)==null?void 0:D.docs)==null?void 0:L.source}}};var P,E,O;h.parameters={...h.parameters,docs:{...(P=h.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; align-items: center; gap: 16px;">
      <forge-icon name="star" size="xs"></forge-icon>
      <forge-icon name="star" size="sm"></forge-icon>
  ...
  \`
}`,...(O=(E=h.parameters)==null?void 0:E.docs)==null?void 0:O.source}}};var _,U,F;x.parameters={...x.parameters,docs:{...(_=x.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(100px, 1fr)); gap: 16px; padding: 20px;">
  ...
  \`
}`,...(le=(ce=C.parameters)==null?void 0:ce.docs)==null?void 0:le.source}}};var de,pe,ge;R.parameters={...R.parameters,docs:{...(de=R.parameters)==null?void 0:de.docs,source:{originalSource:`{
...
}`,...(ge=(pe=R.parameters)==null?void 0:pe.docs)==null?void 0:ge.source}}};const De=["Default","AllSizes","CommonIcons","Animations","Colors","WithLabels","InButtons","LoadingStates","AIReadyIcon","PerformanceMonitoring","IconGrid","CustomIconRegistration"];export{M as AIReadyIcon,h as AllSizes,y as Animations,v as Colors,x as CommonIcons,R as CustomIconRegistration,u as Default,C as IconGrid,w as InButtons,z as LoadingStates,I as PerformanceMonitoring,b as WithLabels,De as __namedExportsOrder,Te as default};
