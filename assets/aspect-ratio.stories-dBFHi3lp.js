import{x as i}from"./iframe-C-1QsWs8.js";import"./preload-helper-C1FmrZbK.js";const D={title:"Components/Atoms/AspectRatio",component:"forge-aspect-ratio",parameters:{docs:{description:{component:"Aspect ratio component that maintains consistent proportions for content. Essential for responsive design and media containers. Supports common presets and custom ratios."}}},argTypes:{ratio:{control:{type:"select"},options:["1:1","16:9","4:3","3:2","21:9","2:1","3:4","9:16"],description:"Aspect ratio preset (width:height)"},value:{control:{type:"number",min:.1,max:10,step:.1},description:"Custom aspect ratio value (overrides ratio string)"},maxWidth:{control:{type:"text"},description:"Maximum width constraint (CSS value)"},maxHeight:{control:{type:"text"},description:"Maximum height constraint (CSS value)"},center:{control:{type:"boolean"},description:"Whether to center content within the container"},objectFit:{control:{type:"select"},options:["fill","contain","cover","none","scale-down"],description:"Object fit behavior for media content"}}},r={args:{ratio:"16:9",value:0,maxWidth:"",maxHeight:"",center:!0,objectFit:"cover"},render:e=>i`
    <forge-aspect-ratio
      ratio=${e.ratio}
      value=${e.value||void 0}
      max-width=${e.maxWidth||void 0}
      max-height=${e.maxHeight||void 0}
      ?center=${e.center}
  ...
  `},o={render:()=>i`
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 24px;">
      ${["1:1","16:9","4:3","3:2","21:9","2:1"].map(e=>i`
        <div>
          <h4 style="margin: 0 0 8px 0; font-size: 14px; font-weight: 600; color: var(--forge-color-text, #1f2937);">${e}</h4>
          <forge-aspect-ratio ratio=${e} style="border: 1px solid var(--forge-color-border, #e5e7eb); border-radius: 8px; overflow: hidden;">
            <div style="
              width: 100%;
              height: 100%;
    ...
    <div style="display: flex; flex-direction: column; gap: 32px; max-width: 800px;">
      ...
      <div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
          ${Array.from({length:4},(e,t)=>i`
            <forge-aspect-ratio ratio="4:3" style="border-radius: 8px; overflow: hidden;">
              <div style="
                width: 100%;
                height: 100%;
                background: linear-gradient(${45+t*90}deg, 
                  ${["#ff6b6b","#4ecdc4","#45b7d1","#96ceb4"][t]} 0%, 
                  ${["#feca57","#ff9ff3","#54a0ff","#dda0dd"][t]} 100%);
                display: flex;
                align-items: center;
                justify-content: center;
                color: white;
            ...
            <forge-aspect-ratio ratio="1:1" style="border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgb(0 0 0 / 0.1);">
              ...
              ">
                <div style="
                  ...
                  font-size: 20px;
                ">${["👨‍💻","👩‍🎨","👨‍🔬"][t]}</div>
                <span style="font-weight: 600; font-size: 14px;">User ${t+1}</span>
    ...
    <div style="display: flex; flex-direction: column; gap: 40px;">
      ...
      <div>
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 4px; max-width: 300px; margin: 0 auto;">
          ${Array.from({length:9},(e,t)=>i`
            <forge-aspect-ratio ratio="1:1">
              <div style="
                width: 100%;
                height: 100%;
                background: linear-gradient(${t*40}deg, 
                  hsl(${t*40}, 70%, 60%) 0%, 
                  hsl(${t*40+60}, 70%, 50%) 100%);
                display: flex;
                align-items: center;
                justify-content: center;
                color: white;
              ...
              " @mouseenter=${n=>n.target.style.transform="scale(1.05)"}
                 @mouseleave=${n=>n.target.style.transform="scale(1)"}>
                Post ${t+1}
              </div>
            </forge-aspect-ratio>
          `)}
  ...
  `},l={render:()=>{const e=["1:1","16:9","4:3","3:2","21:9","2:1","3:4","9:16"];let t=0;return i`
      <div style="max-width: 500px;">
        <div style="margin-bottom: 20px;">
          <forge-button id="ratio-button" @click=${()=>{t=(t+1)%e.length;const c=document.querySelector("#interactive-aspect-ratio"),g=document.querySelector("#ratio-button");c&&g&&(c.setAttribute("ratio",e[t]),g.textContent=`Current: ${e[t]} (Click for next)`)}} variant="primary">
            Current: ${e[0]} (Click for next)
          </forge-button>
        </div>
    ...
    `}};var f,x,h;r.parameters={...r.parameters,docs:{...(f=r.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    ratio: '16:9',
    value: 0,
    maxWidth: '',
  ...
  \`
}`,...(h=(x=r.parameters)==null?void 0:x.docs)==null?void 0:h.source}}};var m,y,u;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 24px;">
  ...
  \`
}`,...(u=(y=o.parameters)==null?void 0:y.docs)==null?void 0:u.source}}};var v,b,w;a.parameters={...a.parameters,docs:{...(v=a.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 32px; max-width: 800px;">
      <div>
        <h3 style="margin: 0 0 16px 0; font-size: 18px; font-weight: 600;">Video Content (16:9)</h3>
  ...
  \`
}`,...(w=(b=a.parameters)==null?void 0:b.docs)==null?void 0:w.source}}};var z,$,k;s.parameters={...s.parameters,docs:{...(z=s.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 24px; max-width: 600px;">
      <div>
        <h4 style="margin: 0 0 12px 0; font-size: 16px; font-weight: 600;">Custom Numeric Value (2.5:1)</h4>
  ...
  \`
}`,...(k=($=s.parameters)==null?void 0:$.docs)==null?void 0:k.source}}};var j,C,P;d.parameters={...d.parameters,docs:{...(j=d.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 32px;">
      <div>
        <h4 style="margin: 0 0 16px 0; font-size: 16px; font-weight: 600;">Maximum Width Constraint</h4>
  ...
  \`
}`,...(P=(C=d.parameters)==null?void 0:C.docs)==null?void 0:P.source}}};var S,R,M;p.parameters={...p.parameters,docs:{...(S=p.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 40px;">
      <div>
        <h3 style="margin: 0 0 20px 0; font-size: 18px; font-weight: 600;">YouTube Video Embed</h3>
  ...
  \`
}`,...(M=(R=p.parameters)==null?void 0:R.docs)==null?void 0:M.source}}};var W,A,H;l.parameters={...l.parameters,docs:{...(W=l.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => {
...
}`,...(H=(A=l.parameters)==null?void 0:A.docs)==null?void 0:H.source}}};const U=["Default","CommonRatios","MediaContent","CustomRatios","WithConstraints","RealWorldExamples","InteractiveDemo"];export{o as CommonRatios,s as CustomRatios,r as Default,l as InteractiveDemo,a as MediaContent,p as RealWorldExamples,d as WithConstraints,U as __namedExportsOrder,D as default};
