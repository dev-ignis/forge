import{x as e}from"./iframe-ppHbX3S9.js";import"./preload-helper-C1FmrZbK.js";const se={title:"Atoms/Alert",component:"forge-alert",tags:["autodocs"],argTypes:{severity:{control:{type:"select"},options:["info","success","warning","error"],description:"Alert severity level",defaultValue:"info"},variant:{control:{type:"select"},options:["standard","filled","outlined"],description:"Visual variant",defaultValue:"standard"},title:{control:{type:"text"},description:"Alert title"},message:{control:{type:"text"},description:"Alert message"},closable:{control:{type:"boolean"},description:"Show close button",defaultValue:!1},animateIn:{control:{type:"boolean"},description:"Animate on mount",defaultValue:!1},autoDismiss:{control:{type:"number"},description:"Auto dismiss after milliseconds (0 = disabled)",defaultValue:0},icon:{control:{type:"text"},description:"Custom icon name"},semanticRole:{control:{type:"text"},description:"Semantic role for AI understanding"},aiContext:{control:{type:"text"},description:"Context for AI assistants"},maxRenderMs:{control:{type:"number"},description:"Maximum render time in milliseconds",defaultValue:16},warnOnViolation:{control:{type:"boolean"},description:"Warn on performance violations",defaultValue:!1},performanceMode:{control:{type:"select"},options:["auto","fast","normal"],description:"Performance mode setting",defaultValue:"auto"},devMode:{control:{type:"boolean"},description:"Enable development mode",defaultValue:!1},showMetrics:{control:{type:"boolean"},description:"Show performance metrics",defaultValue:!1}},parameters:{docs:{description:{component:`
...
\`\`\`
    ...
    <forge-alert
      severity="${r.severity}"
      variant="${r.variant}"
      title="${r.title||"Alert Title"}"
      message="${r.message||"This is an alert message."}"
      ?closable="${r.closable}"
      ?animate-in="${r.animateIn}"
      auto-dismiss="${r.autoDismiss||0}"
      icon="${r.icon||""}"
    ></forge-alert>
  `},a={render:()=>e`
  ...
  `},m={name:"AI-Ready Alert",render:()=>e`
    <forge-alert 
      severity="error"
  ...
  `},f={name:"Performance Monitoring",render:()=>e`
    <forge-alert 
      severity="info"
  ...
  `},u={name:"Notification Stack",render:()=>e`
  ...
  `},p={name:"Inline Form Alert",render:()=>e`
  ...
  `};var v,y,b;t.parameters={...t.parameters,docs:{...(v=t.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: args => html\`
    <forge-alert
    ...
    ></forge-alert>
  \`
}`,...(b=(y=t.parameters)==null?void 0:y.docs)==null?void 0:b.source}}};var h,x,w;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 16px;">
      <forge-alert severity="info" title="Info" message="This is an informational message."></forge-alert>
      <forge-alert severity="success" title="Success" message="Your action was completed successfully!"></forge-alert>
  ...
  \`
}`,...(w=(x=a.parameters)==null?void 0:x.docs)==null?void 0:w.source}}};var A,S,C;o.parameters={...o.parameters,docs:{...(A=o.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 16px;">
      <h3 style="margin: 0 0 8px 0; font-size: 14px; font-weight: 600;">Standard Variant</h3>
      <forge-alert severity="info" variant="standard" title="Standard Info" message="Standard variant with light background"></forge-alert>
  ...
  \`
}`,...(C=(S=o.parameters)==null?void 0:S.docs)==null?void 0:C.source}}};var k,I,z;n.parameters={...n.parameters,docs:{...(k=n.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 16px;">
      <forge-alert 
        severity="info" 
  ...
  \`
}`,...(z=(I=n.parameters)==null?void 0:I.docs)==null?void 0:z.source}}};var P,F,V;s.parameters={...s.parameters,docs:{...(P=s.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => html\`
    <forge-alert 
      severity="success"
      title="Auto-Dismiss Alert"
  ...
  \`
}`,...(V=(F=s.parameters)==null?void 0:F.docs)==null?void 0:V.source}}};var T,R,M;i.parameters={...i.parameters,docs:{...(T=i.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 16px;">
      <forge-alert severity="error" title="Error with Actions" closable>
        An error occurred while saving your changes.
  ...
  \`
}`,...(M=(R=i.parameters)==null?void 0:R.docs)==null?void 0:M.source}}};var D,E,W;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 16px;">
      <forge-alert 
        severity="info" 
  ...
  \`
}`,...(W=(E=l.parameters)==null?void 0:E.docs)==null?void 0:W.source}}};var $,O,U;c.parameters={...c.parameters,docs:{...($=c.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => html\`
    <forge-alert severity="info" title="Terms and Conditions Update" closable>
      We've updated our terms and conditions. The changes include improved clarity on data usage, 
      enhanced privacy protections, and updated guidelines for acceptable use. These changes will 
  ...
  \`
}`,...(U=(O=c.parameters)==null?void 0:O.docs)==null?void 0:U.source}}};var q,Y,L;d.parameters={...d.parameters,docs:{...(q=d.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 16px;">
      <forge-alert severity="info" message="Simple message without title"></forge-alert>
      <forge-alert severity="success" message="Operation completed successfully!"></forge-alert>
  ...
  \`
}`,...(L=(Y=d.parameters)==null?void 0:Y.docs)==null?void 0:L.source}}};var N,B,J;g.parameters={...g.parameters,docs:{...(N=g.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: () => html\`
    <forge-alert 
      severity="success"
      variant="filled"
  ...
  \`
}`,...(J=(B=g.parameters)==null?void 0:B.docs)==null?void 0:J.source}}};var X,_,j;m.parameters={...m.parameters,docs:{...(X=m.parameters)==null?void 0:X.docs,source:{originalSource:`{
  name: 'AI-Ready Alert',
  render: () => html\`
    <forge-alert 
      severity="error"
  ...
  \`
}`,...(j=(_=m.parameters)==null?void 0:_.docs)==null?void 0:j.source}}};var G,H,K;f.parameters={...f.parameters,docs:{...(G=f.parameters)==null?void 0:G.docs,source:{originalSource:`{
  ...
  \`
}`,...(K=(H=f.parameters)==null?void 0:H.docs)==null?void 0:K.source}}};var Q,Z,ee;u.parameters={...u.parameters,docs:{...(Q=u.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  ...
  \`
}`,...(ee=(Z=u.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var re,te,ae;p.parameters={...p.parameters,docs:{...(re=p.parameters)==null?void 0:re.docs,source:{originalSource:`{
  ...
  \`
}`,...(ae=(te=p.parameters)==null?void 0:te.docs)==null?void 0:ae.source}}};const ie=["Default","AllSeverities","Variants","Closable","AutoDismiss","WithActions","CustomIcons","LongContent","NoTitle","Animated","AIReadyAlert","PerformanceMonitoring","NotificationStack","InlineForm"];export{m as AIReadyAlert,a as AllSeverities,g as Animated,s as AutoDismiss,n as Closable,l as CustomIcons,t as Default,p as InlineForm,c as LongContent,d as NoTitle,u as NotificationStack,f as PerformanceMonitoring,o as Variants,i as WithActions,ie as __namedExportsOrder,se as default};
