...
- [AI Metadata Reference](../ai/metadata-reference.md) - Complete technical reference for AI metadata
- [AI Integration Guide](../ai/integration-guide.md) - Real-world examples and patterns
