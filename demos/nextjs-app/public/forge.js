 ...
 */
const Fe = globalThis, Ke = Fe.ShadowRoot && (Fe.ShadyCSS === void 0 || Fe.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Ge = Symbol(), rt = /* @__PURE__ */ new WeakMap();
let bt = class {
  constructor(t, i, r) {
...
}, st = Ke ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let i = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ct, defineProperty: At, getOwnPropertyDescriptor: Dt, getOwnPropertyNames: Mt, getOwnPropertySymbols: Tt, getPrototypeOf: zt } = Object, Ne = globalThis, ot = Ne.trustedTypes, Ot = ot ? ot.emptyScript : "", Et = Ne.reactiveElementPolyfillSupport, Te = (e, t) => e, je = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Ot : null;
      break;
  ...
  return i;
} }, Xe = (e, t) => !Ct(e, t), at = { attribute: !0, type: String, converter: je, reflect: !1, useDefault: !1, hasChanged: Xe };
...
let _e = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Te("properties"))) {
      const i = this.properties, r = [...Mt(i), ...Tt(i)];
...
_e.elementStyles = [], _e.shadowRootOptions = { mode: "open" }, _e[Te("elementProperties")] = /* @__PURE__ */ new Map(), _e[Te("finalized")] = /* @__PURE__ */ new Map(), Et?.({ ReactiveElement: _e }), (Ne.reactiveElementVersions ??= []).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Je = globalThis, He = Je.trustedTypes, nt = He ? He.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, vt = "$lit$", ge = `lit$${Math.random().toFixed(9).slice(2)}$`, yt = "?" + ge, It = `<${yt}>`, xe = document, Oe = () => xe.createComment(""), Ee = (e) => e === null || typeof e != "object" && typeof e != "function", Ze = Array.isArray, Rt = (e) => Ze(e) || typeof e?.[Symbol.iterator] == "function", Ye = `[ 	
\f\r]`, De = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, lt = /-->/g, dt = />/g, be = RegExp(`>|${Ye}(?:([^\\s"'>=/]+)(${Ye}*=${Ye}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ct = /'/g, ht = /"/g, xt = /^(?:script|style|textarea|title)$/i, Pt = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), l = Pt(1), re = Symbol.for("lit-noChange"), g = Symbol.for("lit-nothing"), pt = /* @__PURE__ */ new WeakMap(), ye = xe.createTreeWalker(xe, 129);
function wt(e, t) {
...
const Bt = (e, t) => {
  ...
  for (let c = 0; c < i; c++) {
    const d = e[c];
    let m, P, p = -1, k = 0;
    for (; k < d.length && (n.lastIndex = k, P = n.exec(d), P !== null); ) k = n.lastIndex, n === De ? P[1] === "!--" ? n = lt : P[1] !== void 0 ? n = dt : P[2] !== void 0 ? (xt.test(P[2]) && (s = RegExp("</" + P[2], "g")), n = be) : P[3] !== void 0 && (n = be) : n === be ? P[0] === ">" ? (n = s ?? De, p = -1) : P[1] === void 0 ? p = -2 : (p = n.lastIndex - P[2].length, m = P[1], n = P[3] === void 0 ? be : P[3] === '"' ? ht : ct) : n === ht || n === ct ? n = be : n === lt || n === dt ? n = De : (n = be, s = void 0);
    const v = n === be && e[c + 1].startsWith("/>") ? " " : "";
    a += n === De ? d + It : p >= 0 ? (r.push(m), d.slice(0, p) + vt + d.slice(p) + ge + v) : d + ge + (p === -2 ? c : v);
  }
  return [wt(e, a + (e[i] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), r];
};
class Ie {
  constructor({ strings: t, _$litType$: i }, r) {
    ...
    this.parts = [];
    let a = 0, n = 0;
    const c = t.length - 1, d = this.parts, [m, P] = Bt(t, i);
    ...
    for (; (s = ye.nextNode()) !== null && d.length < c; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const p of s.getAttributeNames()) if (p.endsWith(vt)) {
          ...
          d.push({ type: 1, index: a, name: H[2], strings: v, ctor: H[1] === "." ? Ft : H[1] === "?" ? qt : H[1] === "@" ? jt : Ue }), s.removeAttribute(p);
        ...
        if (xt.test(s.tagName)) {
          ...
          if (k > 0) {
            ...
            for (let v = 0; v < k; v++) s.append(p[v], Oe()), ye.nextNode(), d.push({ type: 2, index: ++a });
            s.append(p[k], Oe());
          }
        }
      } else if (s.nodeType === 8) if (s.data === yt) d.push({ type: 2, index: a });
      else {
        let p = -1;
...
let Lt = class {
  ...
  u(t) {
    ...
    for (; d !== void 0; ) {
      if (n === d.index) {
        let m;
        d.type === 2 ? m = new Ae(a, a.nextSibling, this, t) : d.type === 1 ? m = new d.ctor(a, d.name, d.strings, this, t) : d.type === 6 && (m = new Ht(a, this, t)), this._$AV.push(m), d = r[++c];
      }
...
class Ae {
  ...
  _$AI(t, i = this) {
    t = Ce(this, t, i), Ee(t) ? t === g || t == null || t === "" ? (this._$AH !== g && this._$AR(), this._$AH = g) : t !== this._$AH && t !== re && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Rt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    const { values: i, _$litType$: r } = t, s = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = Ie.createElement(wt(r.h, r.h[0]), this.options)), r);
    if (this._$AH?._$AD === s) this._$AH.p(i);
    else {
      const a = new Lt(s, this), n = a.u(this.options);
  ...
  k(t) {
    ...
    const i = this._$AH;
    let r, s = 0;
    for (const a of t) s === i.length ? i.push(r = new Ae(this.O(Oe()), this.O(Oe()), this, this.options)) : r = i[s], r._$AI(a), s++;
...
const Nt = { I: Ae }, Ut = Je.litHtmlPolyfillSupport;
Ut?.(Ie, Ae), (Je.litHtmlVersions ??= []).push("3.3.1");
const Vt = (e, t, i) => {
  const r = i?.renderBefore ?? t;
  let s = r._$litPart$;
  if (s === void 0) {
    const a = i?.renderBefore ?? null;
    r._$litPart$ = s = new Ae(t.insertBefore(Oe(), a), a, void 0, i ?? {});
  }
  return s._$AI(e), s;
};
/**
...
ze._$litElement$ = !0, ze.finalized = !0, et.litElementHydrateSupport?.({ LitElement: ze });
const Yt = et.litElementPolyfillSupport;
Yt?.({ LitElement: ze });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Wt = { attribute: !0, type: String, converter: je, reflect: !1, hasChanged: Xe }, Qt = (e = Wt, t, i) => {
...
function o(e) {
  return (t, i) => typeof i == "object" ? Qt(e, t, i) : ((r, s, a) => {
...
var Gt = Object.defineProperty, me = (e, t, i, r) => {
...
var Xt = Object.defineProperty, Jt = Object.getOwnPropertyDescriptor, U = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? Jt(t, i) : t, a = e.length - 1, n; a >= 0; a--)
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: Zt } = Nt, ei = (e) => e.strings === void 0, ut = () => document.createComment(""), Me = (e, t, i) => {
  const r = e._$AA.parentNode, s = t === void 0 ? e._$AB : t._$AA;
  if (i === void 0) {
    const a = r.insertBefore(ut(), s), n = r.insertBefore(ut(), s);
    i = new Zt(a, n, e, e.options);
  } else {
  ...
  return i;
}, ve = (e, t, i = e) => (e._$AI(t, i), e), ti = {}, $t = (e, t = ti) => e._$AH = t, ii = (e) => e._$AH, We = (e) => {
...
const ri = Re(class extends Pe {
  constructor(e) {
    ...
    if (!ei(e)) throw Error("`live` bindings can only contain a single expression");
  }
  render(e) {
    return e;
  }
...
var si = Object.defineProperty, oi = Object.getOwnPropertyDescriptor, S = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? oi(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
  return r && s && si(t, i, s), s;
};
...
const ai = Re(Qe);
var ni = Object.defineProperty, li = Object.getOwnPropertyDescriptor, q = (e, t, i, r) => {
...
let u = class extends f {
  ...
  async fetchIcon(e) {
    ...
    if (!t.ok)
      throw new Error(`Failed to fetch icon: ${t.statusText}`);
    const i = await t.text(), a = new DOMParser().parseFromString(i, "image/svg+xml").querySelector("svg");
    if (!a)
...
u.registerIcons(di);
var ci = Object.defineProperty, hi = Object.getOwnPropertyDescriptor, j = (e, t, i, r) => {
...
j([
  o({ type: String, attribute: "semantic-role" })
], O.prototype, "semanticRole", 2);
j([
  o({ type: String, attribute: "ai-context" })
], O.prototype, "aiContext", 2);
j([
  o({ type: String, attribute: "aria-description" })
], O.prototype, "ariaDescription", 2);
j([
  o({ type: Number, attribute: "max-render-ms" })
], O.prototype, "maxRenderMs", 2);
j([
  o({ type: Boolean, attribute: "warn-on-violation" })
], O.prototype, "warnOnViolation", 2);
j([
  o({ type: String, attribute: "performance-mode" })
], O.prototype, "performanceMode", 2);
j([
  o({ type: Boolean, attribute: "dev-mode" })
], O.prototype, "devMode", 2);
j([
  o({ type: Boolean, attribute: "show-metrics" })
], O.prototype, "showMetrics", 2);
j([
  h()
], O.prototype, "closing", 2);
j([
  h()
], O.prototype, "renderTime", 2);
j([
  h()
], O.prototype, "renderCount", 2);
O = j([
  z("forge-alert")
], O);
var pi = Object.defineProperty, ui = Object.getOwnPropertyDescriptor, T = (e, t, i, r) => {
...
var fi = Object.defineProperty, gi = Object.getOwnPropertyDescriptor, E = (e, t, i, r) => {
...
var mi = Object.defineProperty, bi = Object.getOwnPropertyDescriptor, ee = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? bi(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
...
var vi = Object.defineProperty, yi = Object.getOwnPropertyDescriptor, te = (e, t, i, r) => {
...
var xi = Object.defineProperty, wi = Object.getOwnPropertyDescriptor, I = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? wi(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
...
var $i = Object.defineProperty, ki = Object.getOwnPropertyDescriptor, $e = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? ki(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
...
var Si = Object.defineProperty, _i = Object.getOwnPropertyDescriptor, ce = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? _i(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
  return r && s && Si(t, i, s), s;
};
...
ae = ce([
  z("forge-progress-circle")
], ae);
var Ci = Object.defineProperty, Ai = Object.getOwnPropertyDescriptor, ke = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? Ai(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
  return r && s && Ci(t, i, s), s;
};
...
var Di = Object.defineProperty, Mi = Object.getOwnPropertyDescriptor, Se = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? Mi(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
  return r && s && Di(t, i, s), s;
};
...
fe = Se([
  z("forge-aspect-ratio")
], fe);
var Ti = Object.defineProperty, zi = Object.getOwnPropertyDescriptor, oe = (e, t, i, r) => {
...
var Oi = Object.defineProperty, Ei = Object.getOwnPropertyDescriptor, _ = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? Ei(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
...
var Ii = Object.defineProperty, Ri = Object.getOwnPropertyDescriptor, ie = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? Ri(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
  return r && s && Ii(t, i, s), s;
};
...
G = ie([
  z("forge-multi-select")
], G);
var Pi = Object.defineProperty, Bi = Object.getOwnPropertyDescriptor, R = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? Bi(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
  return r && s && Pi(t, i, s), s;
};
...
const ft = (e, t, i) => {
  ...
  update(e, [t, i, r]) {
    const s = ii(e), { values: a, keys: n } = this.dt(t, i, r);
    ...
    else if (m === void 0 && (m = ft(n, v, H), P = ft(c, p, k)), m.has(c[p])) if (m.has(c[k])) {
    ...
    return this.ut = n, $t(e, d), re;
  }
});
var Li = Object.defineProperty, Fi = Object.getOwnPropertyDescriptor, J = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? Fi(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
...
var qi = Object.defineProperty, ji = Object.getOwnPropertyDescriptor, V = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? ji(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
  return r && s && qi(t, i, s), s;
};
...
var Hi = Object.defineProperty, Ni = Object.getOwnPropertyDescriptor, Y = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? Ni(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
...
var Ui = Object.defineProperty, Vi = Object.getOwnPropertyDescriptor, le = (e, t, i, r) => {
...
var Yi = Object.defineProperty, Wi = Object.getOwnPropertyDescriptor, Be = (e, t, i, r) => {
  for (var s = r > 1 ? void 0 : r ? Wi(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (s = (r ? n(t, i, s) : n(s)) || s);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const kt = "important", Qi = " !" + kt, gt = Re(class extends Pe {
  constructor(e) {
  ...
  update(e, [t]) {
    ...
    for (const r in t) {
      ...
      if (s != null) {
        this.ft.add(r);
        const a = typeof s == "string" && s.endsWith(Qi);
        r.includes("-") || a ? i.setProperty(r, a ? s.slice(0, -11) : s, a ? kt : "") : i[r] = s;
      }
    }
    return re;
  }
...
var Gi = Object.defineProperty, Xi = Object.getOwnPropertyDescriptor, w = (e, t, i, r) => {
...
let b = class extends f {
  ...
  setupVirtualScrolling() {
    this.virtualScrolling && this.gridBody && (this.virtualScroller = new Ji(this.gridBody, {
...
function mt(e, ...t) {
  ...
  for (const r in i) {
    const s = i[r], a = e[r];
    s && typeof s == "object" && !Array.isArray(s) && a && typeof a == "object" && !Array.isArray(a) ? e[r] = mt(
      a,
      s
    ) : e[r] = s;
  }
...
export {
  sr as AIMetadataBuilder,
  or as AIMetadataUtils,
  f as BaseElement,
  hr as ClassBuilder,
  O as ForgeAlert,
  ...
  di as commonIcons,
  gr as createForgeEvent,
  pr as debounce,
  mt as deepMerge,
  fr as generateId,
  lr as isForgeElement,
  dr as isValidSize,
  cr as isValidVariant,
  Le as showToast,
  ur as throttle,
  nr as toast
};
